export const countries = [
    ...
    { 
      ...
      isEuroUnion: true, 
      prefix: "BG", 
      plateFormat: "XX XXXX XX", 
      placeholder: "CA1234XY",
      mask: 'AA9999AA',
      regExp_mask: /([A-Z]{2})+(\s[0-9]{4})$/,
      pattern : {
        translation: {
    ...
    { 
      ...
      isEuroUnion: true, 
      prefix: "IRL", 
      plateFormat: "XX-XX-XXXXX", 
      placeholder: "17W12345",
      mask: '99A99999',
      regExp_mask: /([A-Z]{2})+(\s[0-9]{4})$/,
      pattern : {
        translation: {
    ...
    { 
      ...
      isEuroUnion: false, 
      prefix: "CH", 
      plateFormat: "XX XXXXXX", 
      placeholder: "ZH543210",
      mask: 'AA999999',
      regExp_mask: /([A-Z]{2})+(\s[0-9]{4})$/,
      pattern : {
        translation: {
