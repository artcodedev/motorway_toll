import style from '../../Style/Components/UIKit/UIWhatsAppButton.module.scss'

const UIWhatsAppButton = () => {
    return (
        <>
            <a href="https://wa.me/375336791256" target="_blank" style={{textDecoration: 'none'}}>
                <button className={style['UIWhatsAppButton']}>
                    <svg
                        width="24"
                        height="24"
                        viewBox="0 0 24 24"
...
export default UIWhatsAppButton;